        ...
        <Column>
          <ShadowText>
            <Link
              ...
              aria-label={i18n._("Visit Mobius's website")}
            />
          </ShadowText>
        </Column>
        <Column>
          <ShadowText>
            <Link
              ...
              value={i18n._('Github')}
              aria-label={i18n._("Visit Mobius's GitHub repository")}
            />
          </ShadowText>
        </Column>
        <Column>
          <ShadowText>
            <Link
              ...
              aria-label={i18n._("Read Mobius's user guide")}
            />
          </ShadowText>
        </Column>
        <Column>
          <ShadowText>
            <Link
              ...
              aria-label={i18n._("Visit Mobius's developer documentation")}
            />
          </ShadowText>
        </Column>
      </Row>
